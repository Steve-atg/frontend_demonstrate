      ...
      <div className='container mx-auto px-4 py-16'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto'>
            Take control of your finances with our comprehensive money tracking
            solution. Monitor your spending, track your income, and achieve your
            financial goals.
          </p>
        ...
        >
          <div className='bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Record and categorize all your spending to understand where your
              money goes. Stay on top of your daily expenses with ease.
            </p>
          </div>
          ...
          <div className='bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Keep track of all your income sources including salary, freelance
              work, and passive income streams in one place.
            </p>
          </div>
          ...
          <div className='bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Get detailed insights and reports on your financial habits. Review
              your progress and make informed financial decisions.
            </p>
          </div>
          ...
          <div className='bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Define savings goals and track your progress. Stay motivated with
          ...
          <div className='bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Simple and intuitive interface designed for everyone. Manage your
              finances without any learning curve.
            </p>
          </div>
